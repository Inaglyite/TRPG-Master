...
未提交的过渡回合改动（`docs/archive/2026-09/reports/STRUCTURED_TRANSITION_TURN_20260914.md`，本批在其上叠加，
...
- fixtures：55 正例 + 9 反例；权限矩阵补 `command.record_memory` 与
  `memory_query.submit`。协议文档 `docs/reference/STRUCTURED_PROTOCOL_V1.md` §10。
