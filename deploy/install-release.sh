...
rollback_release() {
    ...
    restore_managed_path "$unit_dir/trpg-master-backup.timer" backup-timer || true
    restore_managed_path "$unit_dir/trpg-master-backup.service" backup-service || true
    restore_managed_path "$unit_dir/trpg-master.service" app-service || true
