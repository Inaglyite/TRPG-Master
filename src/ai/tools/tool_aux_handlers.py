...
The registry stays in :mod:`src.ai.tools.registry`; this module keeps side-effecting legacy
...
from src.ai.tools.tool_runtime import ToolRuntime
...
def register_auxiliary_handlers(
    ...
    *,
    ...
    """Register legacy handlers whose authority is enforced by ``src.ai.tools.registry``."""
