...
class HistoryCompactor:
    ...
    def _replace_window(
        ...
        *,
        ...
        """
        from src.ai.context.context_shadow import compact_engine, rebase_engine
    ...
    def prune_old_tool_results(self) -> int:
        ...
        """
        from src.ai.context.context_events import payload_digest
        from src.ai.context.context_shadow import prune_engine
    ...
    def summarize(self, *, silent: bool = False, allow_rebase_fallback: bool = True) -> bool:
        from src.ai.model.llm import _get_glm
    ...
    def try_model(client: Any, model: str, old_text: str) -> str | None:
        ...
        for attempt in range(2):
            try:
                ...
                from src.ai.model.provider_adapter import classify_provider_error
