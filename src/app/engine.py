...
from src.ai.model.model_streamer import (
    ModelStreamer,
    StreamPolicy,
...
from src.gameplay.characters import settle_case as settle_character_case
...
from src.gameplay.npc_speaker_aliases import build_npc_speaker_aliases
...
from src.storage.database_turn_journal import DatabaseTurnJournal as TurnJournal
...
class GameEngine:
    ...
    def _resolve_discoveries(
        ...
        for match in matches:
            ...
            if severity:
                from src.ai.model.llm import tension
