...
```yaml
name: 莱特的小屋
description: 校园附近一座面积不大、家具齐全的小屋，密斯卡托尼克大学有很多这样的房子出租给教职员工。屋子后门的锁最近刚刚换过，门和窗户上新添了插销。屋内处于整理到一半的混乱状态——莱特当时正在收拾行李准备离开。休息室壁炉里有匆忙焚烧的文件残骸，桌上堆满各种文件。门口地垫上放着一封未拆开的来自疗养院的信。
exits: []
npcs_present: []
```
...
```yaml
name: 轻率琐事古董店
description: 阿卡姆商业区上等地段一条巷子里的小古董店，外表体面受人尊敬。楼上有一间办公室，店后面是储藏室和装卸场。储藏室里有一扇门通向宽敞地下室，堆满包装箱和一台破旧锅炉。地下室隐藏着一扇半掩的活板门，通往迷宫般的深层地下室——那里堆满旧包装盒、大箱子、破棺材和大量人骨，有些骨头被制成工具。中央房间有一口砖砌井，通往食尸鬼居住的黑暗深处。
exits: []
npcs_present:
  - abner_wick
  - hector_kara_feldman
